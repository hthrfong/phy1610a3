...
driver: driver.o initialize_ant.o time_step_ant.o output_time_step.o
	${CXX} -o driver driver.o initialize_ant.o time_step_ant.o output_time_step.o ${LDFLAGS} ${LDLIBS}

# Creates the library files
driver.o: driver.cpp initialize_ant.h time_step_ant.h output_time_step.h
...
clean:
	rm -f driver.o initialize_ant.o time_step_ant.o output_time_step.o driver
